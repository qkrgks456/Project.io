...
<body>
					...
					<c:if test="${dto.cafeName ne null && dto.cafeCheck eq true}">
						<div class="py-3">
							...
							<div class="col-md-9 mb-3">
								<div class="mb-3">
									...
									<textarea class="form-control" id="cafeDetail"
										name="cafeDetail" rows="7">${dto.cafeDetail}</textarea>
								</div>
							</div>
							<div class="col-md-9 mb-3">
								...
								<div id="nineMust" class="invalid-feedback">9장 이하만 등록
									가능합니다</div>
							</div>
							<div class="col-md-9 mb-3">
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio"
										name="parkingCheck" id="parkingCheck2" value="N"
							...
							<div class="col-md-9 mb-3">
								...
								<div class="form-check form-check-inline mx-3">
									<label class="form-check-label" for="childCheck1"> 가능 </label>
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="childCheck"
										...
										<c:if test="${dto.childCheck eq 'N'}">checked</c:if>>
									<label class="form-check-label" for="childCheck2"> 불가 </label>
								</div>
							</div>
							<div class="col-md-9 mb-3">
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio"
										name="rooftopCheck" id="rooftopCheck2" value="N"
							...
							<div class="col-md-9 mb-3">
								...
								<div class="form-check form-check-inline mx-3">
									<label class="form-check-label" for="groupCheck1"> 있음 </label>
										...
										<c:if test="${maps ne null}">
											<div class="col-4 p-1 imagego"
												...
												<i title="${maps.fileIdx}"
													...
													style="margin-left: 95px; font-size: 2.5rem; cursor: pointer;"></i>
												<img title="${maps.fileIdx}"
													src="/photo/${maps.newFileName}"
	...
	<!-- cafeInfo js 추가 -->
	<script src="/Project/assets/js/cafeInfo.js?var=75"></script>
	<!-- main js 추가 -->
