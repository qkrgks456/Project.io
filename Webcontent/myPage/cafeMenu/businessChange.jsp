				...
				<div class="cont container w-50">
					...
					<form id="myinfoform" action="#" method="post"
						...
						<div class="form-floating col-md-9 mb-3">
							<input type="text" class="form-control" id="UserPw"
								placeholder="아이디" value="" required> <label
								for="validationTooltip02" class="fw-bold">현재사업자번호</label>
							<div class="invalid-feedback">10자 이상 입력해주세요</div>
						</div>
						<div class="text-center">
					...
					<form id="myinfoform" action="#" method="post"
						class="needs-validation py-3 visually-hidden" novalidate>
						<div class="text-center">
							<h3 class="fw-bold ">사업자번호변경</h3>
						</div>
						<div class="col-md-9 mb-3 mt-4">
							<label for="formFileMultiple" class="form-label fw-bold">카페이미지
								및 사업자등록증 첨부</label> <input class="form-control" type="file"
								id="formFileMultiple" multiple>
						</div>
						<div class="form-floating col-md-9 mb-3">
							<input type="text" class="form-control" id="UserPw"
								placeholder="아이디" value="" required> <label
								for="validationTooltip02" class="fw-bold">바꿀사업자번호</label>
							<div class="invalid-feedback">10자 이상 입력해주세요</div>
